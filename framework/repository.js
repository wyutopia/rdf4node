...
function _parseCacheKey(data, cacheSpec) {
    ...
    if (cacheSpec.keyNameTemplate) {
        ...
        cacheSpec.keyNameTemplate.split(':').forEach(field => {
            keyNameArray.push(data[field] === undefined ? '*' : tools.plainObjectId(data[field]));
        })
...
class Repository extends EventObject {
    constructor(appCtx, props) {
        ...
        this._model = this.dsFactory.getModel(this.modelName, this.modelSchema, {dsName: this.dsName});
        ...
        this._cache = this.allowCache === true? this.cacheFactory.getCache(this.modelName, props.cacheOptions.props) : null;
    }
    getModel() {
        return this._model;
    }
